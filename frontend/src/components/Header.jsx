    ...
    <div className="bg-gradient-to-r from-slate-900 to-slate-800 px-4 py-3 shadow-lg">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col items-center gap-3 md:flex-row md:justify-between md:gap-4">
          ...
          {/* Left Logo Section - Company Logo with Tagline */}
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="text-right">
              <div className="text-white text-[10px] font-semibold md:text-xs">Accredited Training Centre</div>
              <div className="text-indigo-300 text-[8px] md:text-[10px]">Quality Assured</div>
            </div>
          </div>
        </div>
      </div>
